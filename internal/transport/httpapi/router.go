...
func NewRouter(svc *service.Service) *gin.Engine {
	...
	api := r.Group("/api/v1")
	{
		...
		admin := api.Group("/admin")
		{
			...
			protected.GET("/plugins/health", srv.requirePermission("plugin.read"), srv.adminPluginHealthSummary)
			...
			protected.POST("/plugins/packages/templates/export", srv.requirePermission("plugin.write"), srv.exportAdminPluginPackageTemplate)
			protected.POST("/plugins/templates/preview", srv.requirePermission("plugin.write"), srv.previewAdminPluginPackageTemplate)
			protected.POST("/plugins/templates", srv.requirePermission("plugin.write"), srv.createAdminPluginPackageTemplate)
			protected.POST("/plugins/templates/export", srv.requirePermission("plugin.write"), srv.exportAdminPluginPackageTemplate)
			protected.POST("/plugins/packages/upload", srv.requirePermission("plugin.write"), srv.uploadAdminPluginPackageZip)
			protected.GET("/plugins/packages/uploads", srv.requirePermission("plugin.read"), srv.listAdminPluginPackageUploads)
			protected.POST("/plugins/packages/uploads/cleanup", srv.requirePermission("plugin.write"), srv.cleanupAdminPluginPackageUploads)
			protected.GET("/plugins/packages/uploads/:upload_id", srv.requirePermission("plugin.read"), srv.adminPluginPackageUploadDetail)
			protected.POST("/plugins/packages/uploads/:upload_id/rescan", srv.requirePermission("plugin.write"), srv.rescanAdminPluginPackageUpload)
			protected.POST("/plugins/packages/uploads/:upload_id/cancel", srv.requirePermission("plugin.write"), srv.cancelAdminPluginPackageUpload)
			protected.DELETE("/plugins/packages/uploads/:upload_id", srv.requirePermission("plugin.write"), srv.deleteAdminPluginPackageUpload)
			protected.POST("/plugins/packages/uploads/:upload_id/approval", srv.requirePermission("plugin.write"), srv.submitAdminPluginPackageUploadApproval)
			protected.POST("/plugins/packages/uploads/:upload_id/approve", srv.requirePermission("plugin.approve"), srv.approveAdminPluginPackageUpload)
			protected.POST("/plugins/packages/uploads/:upload_id/reject", srv.requirePermission("plugin.approve"), srv.rejectAdminPluginPackageUpload)
			protected.POST("/plugins/packages/uploads/:upload_id/promote", srv.requirePermission("plugin.write"), srv.promoteAdminPluginPackageUpload)
			protected.POST("/plugins/packages/download", srv.requirePermission("plugin.write"), srv.downloadAdminPluginPackageToStaging)
			protected.GET("/plugins/packages/staging", srv.requirePermission("plugin.read"), srv.listAdminPluginPackageStaging)
			protected.GET("/plugins/packages/staging/:id", srv.requirePermission("plugin.read"), srv.adminPluginPackageStagingDetail)
			protected.DELETE("/plugins/packages/staging/:id", srv.requirePermission("plugin.write"), srv.deleteAdminPluginPackageStaging)
			protected.POST("/plugins/packages/prechecks/:id/compat-check", srv.requirePermission("plugin.write"), srv.runAdminPluginPackageCompatCheck)
			protected.POST("/plugins/packages/prechecks/:id/verify-signature", srv.requirePermission("plugin.write"), srv.verifyAdminPluginPackageSignature)
			protected.GET("/plugins/packages/compat-checks", srv.requirePermission("plugin.read"), srv.listAdminPluginPackageCompatChecks)
			protected.GET("/plugins/packages/compat-checks/:id", srv.requirePermission("plugin.read"), srv.adminPluginPackageCompatCheckDetail)
			protected.DELETE("/plugins/packages/compat-checks/:id", srv.requirePermission("plugin.write"), srv.deleteAdminPluginPackageCompatCheck)
			protected.GET("/plugins/packages/signatures", srv.requirePermission("plugin.read"), srv.listAdminPluginPackageSignatures)
			protected.GET("/plugins/packages/signatures/:id", srv.requirePermission("plugin.read"), srv.adminPluginPackageSignatureDetail)
			protected.DELETE("/plugins/packages/signatures/:id", srv.requirePermission("plugin.write"), srv.deleteAdminPluginPackageSignature)
			protected.POST("/plugins/:code/enable-precheck", srv.requirePermission("plugin.write"), srv.runAdminPluginEnablePrecheck)
			protected.GET("/plugins/enable-prechecks", srv.requirePermission("plugin.read"), srv.listAdminPluginEnablePrechecks)
			protected.GET("/plugins/enable-prechecks/:id", srv.requirePermission("plugin.read"), srv.adminPluginEnablePrecheckDetail)
			protected.DELETE("/plugins/enable-prechecks/:id", srv.requirePermission("plugin.write"), srv.deleteAdminPluginEnablePrecheck)
			protected.POST("/plugins/enable-prechecks/:id/enable", srv.requirePermission("plugin.write"), srv.enablePluginFromPrecheck)
			protected.GET("/plugins/enable-tasks", srv.requirePermission("plugin.read"), srv.listAdminPluginEnableTasks)
			protected.GET("/plugins/enable-tasks/:id", srv.requirePermission("plugin.read"), srv.adminPluginEnableTaskDetail)
			protected.POST("/plugins/enable-tasks/:id/retry", srv.requirePermission("plugin.write"), srv.retryAdminPluginEnableTask)
			protected.DELETE("/plugins/enable-tasks/:id", srv.requirePermission("plugin.write"), srv.deleteAdminPluginEnableTask)
			// v1.7.0-P0-07: soft uninstall tasks (archive + task record + dependency guard).
			protected.GET("/plugins/:code/uninstall-impact", srv.requirePermission("plugin.read"), srv.adminPluginUninstallImpact)
			protected.POST("/plugins/:code/soft-uninstall", srv.requirePermission("plugin.write"), srv.softUninstallAdminPlugin)
			protected.GET("/plugins/uninstall-tasks", srv.requirePermission("plugin.read"), srv.listAdminPluginUninstallTasks)
			protected.GET("/plugins/uninstall-tasks/:id", srv.requirePermission("plugin.read"), srv.adminPluginUninstallTaskDetail)
			protected.POST("/plugins/uninstall-tasks/:id/retry", srv.requirePermission("plugin.write"), srv.retryAdminPluginUninstallTask)
			protected.DELETE("/plugins/uninstall-tasks/:id", srv.requirePermission("plugin.write"), srv.deleteAdminPluginUninstallTask)
			protected.GET("/plugins/remote-indexes", srv.requirePermission("plugin.read"), srv.listAdminPluginRemoteIndexes)
			protected.POST("/plugins/remote-indexes", srv.requirePermission("plugin.manage"), srv.createAdminPluginRemoteIndex)
			protected.PUT("/plugins/remote-indexes/:id", srv.requirePermission("plugin.manage"), srv.updateAdminPluginRemoteIndex)
			protected.POST("/plugins/remote-indexes/:id/enable", srv.requirePermission("plugin.manage"), srv.enableAdminPluginRemoteIndex)
			protected.POST("/plugins/remote-indexes/:id/disable", srv.requirePermission("plugin.manage"), srv.disableAdminPluginRemoteIndex)
			protected.DELETE("/plugins/remote-indexes/:id", srv.requirePermission("plugin.manage"), srv.deleteAdminPluginRemoteIndex)
			protected.POST("/plugins/remote-indexes/:id/fetch", srv.requirePermission("plugin.manage"), srv.fetchAdminPluginRemoteIndex)
			protected.GET("/plugins/remote-indexes/:id/plugins", srv.requirePermission("plugin.read"), srv.listAdminPluginRemoteIndexPlugins)
			protected.GET("/plugins/remote-indexes/:id/plugins/:code", srv.requirePermission("plugin.read"), srv.adminPluginRemoteIndexPluginDetail)
			protected.GET("/plugins/trusted-publishers", srv.requirePermission("plugin.read"), srv.listAdminPluginTrustedPublishers)
			protected.POST("/plugins/trusted-publishers", srv.requirePermission("plugin.manage"), srv.createAdminPluginTrustedPublisher)
			protected.GET("/plugins/trusted-publishers/:id", srv.requirePermission("plugin.read"), srv.adminPluginTrustedPublisherDetail)
			protected.PUT("/plugins/trusted-publishers/:id", srv.requirePermission("plugin.manage"), srv.updateAdminPluginTrustedPublisher)
			protected.POST("/plugins/trusted-publishers/:id/block", srv.requirePermission("plugin.manage"), srv.blockAdminPluginTrustedPublisher)
			protected.POST("/plugins/trusted-publishers/:id/revoke", srv.requirePermission("plugin.manage"), srv.revokeAdminPluginTrustedPublisher)
			protected.POST("/plugins/trusted-publishers/:id/restore", srv.requirePermission("plugin.manage"), srv.restoreAdminPluginTrustedPublisher)
			protected.DELETE("/plugins/trusted-publishers/:id", srv.requirePermission("plugin.manage"), srv.deleteAdminPluginTrustedPublisher)
			protected.POST("/plugins/packages/dry-run", srv.requirePermission("plugin.write"), srv.dryRunAdminPluginPackage)
			protected.POST("/plugins/packages/cleanup/preview", srv.requirePermission("plugin.write"), srv.previewAdminPluginPackageRepositoryCleanup)
			protected.POST("/plugins/packages/cleanup", srv.requirePermission("plugin.approve"), srv.cleanupAdminPluginPackageRepository)
			protected.POST("/plugins/packages/repository/cleanup", srv.requirePermission("plugin.approve"), srv.cleanupAdminPluginPackageRepository)
			...
			protected.POST("/plugins/packages/repository/promote", srv.requirePermission("plugin.write"), srv.promoteAdminPluginPackageDraft)
			protected.DELETE("/plugins/packages", srv.requirePermission("plugin.write"), srv.deleteAdminPluginPackageRepository)
			protected.DELETE("/plugins/packages/repository", srv.requirePermission("plugin.write"), srv.deleteAdminPluginPackageRepository)
			protected.GET("/plugins/versions", srv.requirePermission("plugin.read"), srv.listAdminPluginVersions)
			// v1.6.0-P0-06: plugin operations (install/upgrade protection & recovery).
			protected.GET("/plugins/operations", srv.requirePermission("plugin.read"), srv.listAdminPluginOperations)
			protected.GET("/plugins/operations/:operation_id", srv.requirePermission("plugin.read"), srv.adminPluginOperationDetail)
			protected.POST("/plugins/operations/:operation_id/recover/dry-run", srv.requirePermission("plugin.manage"), srv.recoverDryRunAdminPluginOperation)
			protected.POST("/plugins/operations/:operation_id/cleanup", srv.requirePermission("plugin.manage"), srv.cleanupAdminPluginOperation)
			// v1.6.0-P1-07: plugin config key rotation (status + dry-run + re-encrypt).
			...
			// v1.7.0-P0-08: plugin upgrade tasks (compat-check driven; no auto-enable, no migrations executed).
			protected.GET("/plugins/:code/upgrade-impact", srv.requirePermission("plugin.read"), srv.adminPluginUpgradeImpact)
			protected.POST("/plugins/:code/upgrade-from-package", srv.requirePermission("plugin.approve"), srv.upgradeAdminPluginFromCompat)
			protected.GET("/plugins/upgrade-tasks", srv.requirePermission("plugin.read"), srv.listAdminPluginUpgradeTasks)
			protected.GET("/plugins/upgrade-tasks/:id", srv.requirePermission("plugin.read"), srv.adminPluginUpgradeTaskDetail)
			protected.POST("/plugins/upgrade-tasks/:id/retry", srv.requirePermission("plugin.approve"), srv.retryAdminPluginUpgradeTask)
			protected.DELETE("/plugins/upgrade-tasks/:id", srv.requirePermission("plugin.approve"), srv.deleteAdminPluginUpgradeTask)
			protected.GET("/plugins/:code/versions", srv.requirePermission("plugin.read"), srv.listAdminPluginCodeVersions)
			protected.GET("/plugins/:code/versions/:version", srv.requirePermission("plugin.read"), srv.adminPluginVersionDetail)
			protected.POST("/plugins/:code/versions/:version/upgrade-diff", srv.requirePermission("plugin.write"), srv.dryRunAdminPluginVersionUpgradeDiff)
			...
			protected.GET("/plugins/hooks/executions", srv.requirePermission("plugin.read"), srv.listAdminPluginHookExecutions)
			...
			protected.GET("/plugins/:code/external-service/effective-config", srv.requirePermission("plugin.read"), srv.adminPluginExternalServiceEffectiveConfig)
			...
			protected.GET("/system/sensitive-config/status", srv.requirePermission("setting.read"), srv.adminSystemSensitiveConfigStatus)
			protected.GET("/system/effective-config", srv.requirePermission("setting.read"), srv.adminSystemEffectiveConfig)
			protected.GET("/system/external-service/http-allowlist", srv.requirePermission("setting.read"), srv.adminExternalServiceHTTPAllowlist)
			protected.POST("/system/external-service/http-allowlist", srv.requirePermission("setting.write"), srv.createAdminExternalServiceHTTPAllowlist)
			protected.DELETE("/system/external-service/http-allowlist/:id", srv.requirePermission("setting.write"), srv.deleteAdminExternalServiceHTTPAllowlist)
			// v1.8.4-S14: Core SecretCenter (metadata only; never returns plaintext secret values).
			protected.GET("/secret-center/secrets", srv.requirePermission("setting.read"), srv.adminListSecretRefs)
			protected.GET("/secret-center/secrets/metadata", srv.requirePermission("setting.read"), srv.adminGetSecretRefMetadata)
			protected.GET("/secret-center/secrets/detail", srv.requirePermission("setting.read"), srv.adminGetSecretRefDetail)
			protected.GET("/secret-center/secrets/usages", srv.requirePermission("setting.read"), srv.adminGetSecretRefUsages)
			protected.GET("/system/secrets", srv.requirePermission("setting.read"), srv.adminListSecretRefs)
			protected.GET("/system/secrets/metadata", srv.requirePermission("setting.read"), srv.adminGetSecretRefMetadata)
			protected.GET("/system/secrets/detail", srv.requirePermission("setting.read"), srv.adminGetSecretRefDetail)
			protected.GET("/system/secrets/usages", srv.requirePermission("setting.read"), srv.adminGetSecretRefUsages)
			protected.POST("/secret-center/secrets", srv.requirePermission("setting.write"), srv.adminCreateSecretRef)
			protected.PUT("/secret-center/secrets", srv.requirePermission("setting.write"), srv.adminUpdateSecretRef)
			protected.POST("/secret-center/secrets/disable/preview", srv.requirePermission("setting.read"), srv.adminPreviewDisableSecretRef)
			protected.POST("/secret-center/secrets/revoke/preview", srv.requirePermission("setting.read"), srv.adminPreviewRevokeSecretRef)
			protected.POST("/secret-center/secrets/disable", requireSecretManage(), srv.adminDisableSecretRef)
			protected.POST("/secret-center/secrets/revoke", requireSecretManage(), srv.adminRevokeSecretRef)
			protected.POST("/system/secrets/disable/preview", srv.requirePermission("setting.read"), srv.adminPreviewDisableSecretRef)
			protected.POST("/system/secrets/revoke/preview", srv.requirePermission("setting.read"), srv.adminPreviewRevokeSecretRef)
			protected.POST("/system/secrets/disable", requireSecretManage(), srv.adminDisableSecretRef)
			protected.POST("/system/secrets/revoke", requireSecretManage(), srv.adminRevokeSecretRef)
	...
	r.GET("/feishu-links/new", func(c *gin.Context) {
		c.Redirect(http.StatusFound, "/topics/new/?type=feishu_link")
	})
	r.GET("/feishu-links/new/", func(c *gin.Context) {
		c.Redirect(http.StatusFound, "/topics/new/?type=feishu_link")
	})
...
func (s *Server) adminPlugins(c *gin.Context) {
	...
	for i := range items {
		if health, err := s.svc.PluginHealth(items[i].Code); err == nil {
			...
			items[i].HealthStatus = health.Status
...
func (s *Server) adminPluginHealthSummary(c *gin.Context) {
	items := s.svc.Plugins()
	summary := gin.H{
		"healthy":            0,
		"warning":            0,
	...
	for _, plugin := range items {
		health, err := s.svc.PluginHealth(plugin.Code)
...
func (s *Server) adminPluginHealth(c *gin.Context) {
	...
	for _, menu := range plugin.Menus {
		...
		if item.Visible && requireConfigValid {
			if err := pluginregistry.ValidateConfigJSON(plugin, plugin.ConfigJSON); err != nil {
				...
				item.Reason = "插件配置无效"
			} else if pluginConfigExplicitlyDisabled(plugin) {
				item.Visible = false
				item.ReasonCode = "plugin_config_disabled"
				item.Reason = "插件配置已关闭展示"
			}
		}
...
func (s *Server) bulkArchiveAdminPlugins(c *gin.Context) {
	...
	result := s.svc.BulkArchivePlugins(req.Codes)
	s.auditStructured(c, "system", "plugin.bulk_archived", "plugins#bulk", nil,
		gin.H{"succeeded": len(result.Succeeded), "failed": len(result.Failed)},
		gin.H{"plugin_codes": req.Codes, "result": result})
	c.JSON(http.StatusOK, result)
}

func (s *Server) bulkRestoreAdminPlugins(c *gin.Context) {
	var req struct {
		Codes []string `json:"codes"`
	}
	if err := c.ShouldBindJSON(&req); err != nil {
	...
	result := s.svc.BulkRestorePlugins(req.Codes)
	s.auditStructured(c, "system", "plugin.bulk_restored", "plugins#bulk", nil,
		gin.H{"succeeded": len(result.Succeeded), "failed": len(result.Failed)},
		gin.H{"plugin_codes": req.Codes, "result": result})
	c.JSON(http.StatusOK, result)
}

func (s *Server) parseAndValidatePluginManifest(c *gin.Context) (domain.PluginManifestValidationResult, error) {
	raw, err := c.GetRawData()
	if err != nil {
		return domain.PluginManifestValidationResult{}, err
	}
	manifestJSON, err := extractManifestJSON(raw)
	if err != nil {
		return domain.PluginManifestValidationResult{}, err
	}
	return s.svc.ValidatePluginManifestJSON(manifestJSON)
}
...
func extractManifestJSON(raw []byte) ([]byte, error) {
	...
	if err := json.Unmarshal(trimmed, &wrapper); err == nil && len(bytes.TrimSpace(wrapper.Manifest)) > 0 {
...
func (s *Server) adminPluginHookExecutions(c *gin.Context) {
	...
	s.listPluginHookExecutions(c, code)
}

func (s *Server) listAdminPluginHookExecutions(c *gin.Context) {
	s.listPluginHookExecutions(c, strings.TrimSpace(c.Query("plugin_code")))
}

func (s *Server) listPluginHookExecutions(c *gin.Context, code string) {
	if code != "" {
		if _, ok := s.svc.PluginByCode(code); !ok {
			failAPIError(c, domain.NewPluginError("plugin_not_found", "插件不存在").WithStatus(404).WithDetail("plugin_code", code))
			return
...
func (s *Server) createAdminPost(c *gin.Context) {
	...
	permission := s.svc.ContentTypeCreatePermission(topicReq.ContentType, topicReq.PluginCode)
	...
	if req.Status != "" && req.Status != "publish" {
		...
		// NOTE: SetTopicStatus may return (nil, nil) in some edge cases; do not
		// overwrite the created topic pointer and later panic on dereference.
		if updated, err := s.svc.SetTopicStatus(topic.ID, status); err == nil && updated != nil {
			topic = updated
		}
	}
	if topic == nil {
		fail(c, http.StatusInternalServerError, "创建主题失败")
		return
	}
...
func failAPIError(c *gin.Context, err error) {
	...
	if apiErr, ok := err.(*domain.APIError); ok && apiErr != nil {
		...
		if len(apiErr.Diagnostics) > 0 {
			payload["diagnostics"] = apiErr.Diagnostics
		}
...
func pluginConfigExplicitlyDisabled(plugin domain.Plugin) bool {
	raw := strings.TrimSpace(plugin.ConfigJSON)
	if raw == "" {
		return false
	}
	...
	for _, plugin := range s.svc.Plugins() {
		...
		for _, menu := range plugin.Menus {
			...
			if entry.RequireLogin && ctx.UserID == 0 {
				...
				entry.Visible = false
				entry.ReasonCode = "plugin_config_disabled"
				entry.Reason = "插件配置已关闭展示"
...
func (s *Server) communityCreateOptions(c *gin.Context) {
	...
	type contentTypeOptionDef struct {
		Type             string
		Name             string
		PluginCode       string
		CreatePermission string
	}
	optionDefs := []contentTypeOptionDef{}
	seenContentTypes := map[string]bool{}
	addOptionDef := func(def contentTypeOptionDef) {
		def.Type = pluginregistry.NormalizeContentType(def.Type)
		def.PluginCode = strings.TrimSpace(def.PluginCode)
		if def.Type == "" || seenContentTypes[def.Type] {
			return
		}
		if def.PluginCode == "" {
			def.PluginCode = pluginregistry.PluginCodeForContentType(def.Type)
		}
		if strings.TrimSpace(def.Name) == "" {
			def.Name = def.Type
		}
		seenContentTypes[def.Type] = true
	...
	for _, ct := range []string{"article", "question", "project", "ai_work", "job", "wiki_page", "document"} {
		...
		addOptionDef(contentTypeOptionDef{
			Type:             ct,
			Name:             firstNonEmpty(def.Name, ct),
			PluginCode:       firstNonEmpty(def.PluginCode, pluginregistry.PluginCodeForContentType(ct)),
			CreatePermission: strings.TrimSpace(def.CreatePermission),
		})
	}
	for _, p := range s.svc.Plugins() {
		for _, def := range p.ContentTypeDefs {
			addOptionDef(contentTypeOptionDef{
				Type:             def.Type,
				Name:             firstNonEmpty(def.Name, def.Type),
				PluginCode:       firstNonEmpty(def.PluginCode, p.Code),
				CreatePermission: strings.TrimSpace(def.CreatePermission),
			})
		}
...
func (s *Server) searchRequestFromQuery(c *gin.Context) domain.SearchRequest {
	...
	contentType := pluginregistry.NormalizeContentType(firstQuery(c, "content_type", "type"))
	if contentType != "" && !s.svc.IsKnownContentType(contentType) {
		contentType = ""
	}
