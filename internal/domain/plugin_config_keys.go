...
type PluginConfigKeyStatusResponse struct {
	...
	// Startup keyring is always sourced from process env (or external secret providers injected into env).
	// It is never created/saved via DevHub admin UI.
	Source          string   `json:"source,omitempty"` // env
	RestartRequired bool     `json:"restart_required,omitempty"`
	EnvExamples     []string `json:"env_examples,omitempty"`
}
