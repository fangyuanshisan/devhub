...
type PluginPackageCleanupRequest struct {
	...
	IncludePromotedUninstalled bool     `json:"include_promoted_uninstalled,omitempty"`
	IncludeWarningUninstalled  bool     `json:"include_warning_uninstalled,omitempty"`
	IncludeDryRunFailed        bool     `json:"include_dry_run_failed,omitempty"`
}

type PluginPackageCleanupItem struct {
...
type PluginPackageCleanupResponse struct {
	DryRun          bool                       `json:"dry_run"`
	ConfirmRequired bool                       `json:"confirm_required"`
	ConfirmToken    string                     `json:"confirm_token,omitempty"`
	WillDeleteCount int                        `json:"will_delete_count"`
	WillFreeBytes   int64                      `json:"will_free_bytes"`
	WillDeleteFiles int                        `json:"will_delete_files,omitempty"`
	...
	Items           []PluginPackageCleanupItem `json:"items"`
	Errors          []string                   `json:"errors,omitempty"`
	Warnings        []string                   `json:"warnings,omitempty"`
}
