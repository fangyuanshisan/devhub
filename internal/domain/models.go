...
type PluginHealth struct {
	...
	ExternalServiceFailureCount24h          int    `json:"external_service_failure_count_24h,omitempty"`
	ExternalServiceFailureCount7d           int    `json:"external_service_failure_count_7d,omitempty"`
	ExternalServiceRecentError              string `json:"external_service_recent_error,omitempty"`
	ExternalServiceRecentSuccessExecutionID string `json:"external_service_recent_success_execution_id,omitempty"`
	ExternalServiceRecentFailureExecutionID string `json:"external_service_recent_failure_execution_id,omitempty"`
