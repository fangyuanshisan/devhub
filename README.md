...
- v1.3.5 / 收尾：插件治理体验与安装升级向导已在工作区实现，当前重点是发版前验收、skip 处置、PluginContent 小范围对齐和版本切分。
- v1.4.x / P1：插件平台增强，包括 PluginContent 精确治理、插件权限矩阵、schema 自动表单增强、Hook 排障页、插件 SDK / 模板生成器、依赖和版本兼容 UI、插件事件 / 通知模板、搜索索引和 SEO 扩展。
