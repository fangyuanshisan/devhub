...
CREATE TABLE IF NOT EXISTS plugin_uninstall_tasks (
  id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
  plugin_code VARCHAR(64) NOT NULL DEFAULT '',
  version VARCHAR(64) NOT NULL DEFAULT '',
  plugin_installation_id BIGINT UNSIGNED NOT NULL DEFAULT 0,
  plugin_enable_task_id BIGINT UNSIGNED NOT NULL DEFAULT 0,
  status VARCHAR(64) NOT NULL DEFAULT 'pending',
  uninstall_type VARCHAR(32) NOT NULL DEFAULT 'soft',
  previous_status VARCHAR(64) NOT NULL DEFAULT '',
  new_status VARCHAR(64) NOT NULL DEFAULT '',
  affected_contents_count INT NOT NULL DEFAULT 0,
  affected_communities_count INT NOT NULL DEFAULT 0,
  dependent_plugins_json JSON NULL,
  unregistered_content_types_json JSON NULL,
  unregistered_permissions_json JSON NULL,
  unregistered_menus_json JSON NULL,
  unregistered_routes_json JSON NULL,
  unregistered_hooks_json JSON NULL,
  preserved_files_json JSON NULL,
  preserved_configs_json JSON NULL,
  preserved_migrations_json JSON NULL,
  errors_json JSON NULL,
  warnings_json JSON NULL,
  rollback_log_json JSON NULL,
  reason VARCHAR(1000) NOT NULL DEFAULT '',
  ...
  updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (id),
  KEY idx_plugin_uninstall_tasks_status_created (status, created_at),
  KEY idx_plugin_uninstall_tasks_plugin_version (plugin_code, version)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
