...
export const communityNavItems = [
  ...
  { key: 'doc', label: '文档', contentType: 'document' },
  { key: 'wiki', label: 'Wiki', contentType: 'wiki_page' },
  { key: 'project', label: '开源', contentType: 'project' },
  { key: 'ai_work', label: '作品', contentType: 'ai_work' },
  { key: 'friend_link', label: '友情链接', contentType: 'friend_link' },
  { key: 'feishu_link', label: '飞书链接', contentType: 'feishu_link' },
] as const;
...
export const contentTypeOptions = [
  ...
  { value: 'wiki_page', label: 'Wiki', desc: '适合沉淀知识索引和可维护条目。' },
  { value: 'document', label: '文档', desc: '适合发布教程、手册和实践指南。' },
  { value: 'friend_link', label: '友情链接', desc: '适合展示子站或总站推荐链接、合作站点和资源导航。' },
  { value: 'feishu_link', label: '飞书链接', desc: '适合发布飞书文档、多维表格、会议纪要或协作链接。' },
] as const;
...
contentTypeLabelMap.doc = '文档';
contentTypeLabelMap.wiki = 'Wiki';
...
export function contentTypeToBoard(contentType: string) {
  return {
    ...
    doc: 'docs',
    document: 'docs',
    friend_link: 'community',
    feishu_link: 'community',
    news: 'community',
