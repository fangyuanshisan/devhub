  ...
  plugins: [
    {
      ...
      title: '插件管理',
      items: [
        { key: 'overview', label: '插件列表', path: '/plugins/overview', permission: 'plugin.read' },
        { key: 'packages', label: '安装与升级', path: '/plugins/packages', permission: 'plugin.read' },
        { key: 'webhooks', label: 'Webhook 与回调', path: '/plugins/webhooks', permission: 'plugin.read' },
        { key: 'publishers', label: '安全与发布者', path: '/plugins/publishers', permission: 'plugin.read' },
        { key: 'runtime', label: '运行与审计', path: '/plugins/runtime', permission: 'plugin.read' },
      ],
    },
  ],
  system: [
