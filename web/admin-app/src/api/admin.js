...
export const exportPluginPackageTemplate = (payload) => http.post('/admin/plugins/packages/templates/export', payload, { responseType: 'blob' });
export const dryRunPluginPackage = (payload) => http.post('/admin/plugins/packages/dry-run', payload);
export const previewPluginPackageCleanup = (payload) => http.post('/admin/plugins/packages/cleanup/preview', payload);
export const cleanupPluginPackageRepository = (payload) => http.post('/admin/plugins/packages/repository/cleanup', payload);
export const deletePluginPackageRepository = (payload) => http.delete('/admin/plugins/packages/repository', { data: payload });
export const promotePluginPackageRepository = (payload) => http.post('/admin/plugins/packages/repository/promote', payload);
...
export const cleanupPluginPackageUploads = (payload = {}) => http.post('/admin/plugins/packages/uploads/cleanup', payload);
...
export const listPluginHookExecutions = (params) => http.get('/admin/plugins/hooks/executions', { params });
...
export const getPluginExternalServiceEffectiveConfig = (code) => http.get(`/admin/plugins/${encodeURIComponent(code)}/external-service/effective-config`);
...
export const systemSensitiveConfigStatus = () => http.get('/admin/system/sensitive-config/status');
export const systemEffectiveConfig = () => http.get('/admin/system/effective-config');
export const externalServiceHTTPAllowlist = () => http.get('/admin/system/external-service/http-allowlist');
export const createExternalServiceHTTPAllowlist = (payload) => http.post('/admin/system/external-service/http-allowlist', payload);
export const deleteExternalServiceHTTPAllowlist = (id) => http.delete(`/admin/system/external-service/http-allowlist/${encodeURIComponent(id)}`, { params: { confirmed: 'true' } });
export const listSecretRefs = (params) => http.get('/admin/secret-center/secrets', { params });
export const getSecretRefMetadata = (ref) => http.get('/admin/secret-center/secrets/metadata', { params: { ref } });
export const getSecretRefDetail = (ref) => http.get('/admin/secret-center/secrets/detail', { params: { ref } });
export const getSecretRefUsages = (ref) => http.get('/admin/secret-center/secrets/usages', { params: { ref } });
export const previewDisableSecretRef = (ref) => http.post('/admin/secret-center/secrets/disable/preview', { ref });
export const disableSecretRef = (ref) => http.post('/admin/secret-center/secrets/disable', { ref });
export const previewRevokeSecretRef = (ref) => http.post('/admin/secret-center/secrets/revoke/preview', { ref });
export const revokeSecretRef = (ref, payload = {}) => http.post('/admin/secret-center/secrets/revoke', { ref, ...payload });
