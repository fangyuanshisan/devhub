...
import { comments, deleteComment, updateComment } from '@/api/admin';
...
async function setStatus(row, value) { await updateComment(row.id, { status: value }); await load(); }
