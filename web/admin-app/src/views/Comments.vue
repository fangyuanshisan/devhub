<template>
  <el-card shadow="never" data-testid="admin-comments-page">
    ...
    <el-form :inline="true"><el-form-item><el-select v-model="status" style="width: 130px"><el-option label="全部" value="all" /><el-option label="正常" value="normal" /><el-option label="违规" value="illegal" /></el-select></el-form-item><el-form-item><el-input v-model="keyword" placeholder="内容 / 作者 / 标题" clearable data-testid="admin-comments-search" /></el-form-item></el-form>
