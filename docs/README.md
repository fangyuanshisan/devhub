...
6. [备份与回滚文档](BACKUP_AND_ROLLBACK.md)
   - v1.0.0 上线前后需要备份的内容、MySQL 备份恢复、二进制回滚、Git 回滚和紧急回滚流程。

7. [SEO 文档](SEO.md)
   - 百度 SEO 兜底策略，尤其是 `/topics/:id` 动态 HTML 的保护要求。

8. [v1.0.0 Release Notes](releases/v1.0.0.md)
   - 版本定位、启动部署、测试清单、已知限制和下一版本规划。
...
- 版本归档变化后，同步更新 [Release Notes](releases/v1.0.0.md)、[变更日志](../CHANGELOG.md) 和根目录 [VERSION](../VERSION)。
