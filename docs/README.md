...
补充：当前 `VERSION` 已统一为 `v1.8.3`。文档仍以“真实实现 + 设计边界分离”为原则维护；不把未开放的第三方代码执行、远程动态加载、任意远程 iframe、插件市场或 blocking Hook 写成已完成。当前前端插件挂载只支持官方 allowlist，仍不是开放式第三方前端运行时。
...
23. [v1.7.1 Release Notes](releases/v1.7.1.md)
...
24. [v1.7.0 Release Notes](releases/v1.7.0.md)
